...
FieldsDate = ['employment_start_date_1', 'date_time_completed', 'leave_start_date', 'employment_start_date_0',
              'worker_contract_end_date', 'effective_date_1', 'effective_date_0', 'employee_contract_end_date',
              'birth_date', 'join_date', 'issued_date', 'company_service_date', 'expected_assignment_end_date_1',
              'effective_date', 'expected_assignment_end_date_0', 'compensation_effective_date', 'leave_end_date',
