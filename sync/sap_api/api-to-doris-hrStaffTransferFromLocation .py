...
def deal_ods(response, query_url, page_index):
    ...
    insert_count = tmp_dataframe.to_sql(HRStaffTransferFromLocationTableNameOds, tarEngine, if_exists='append', index=False)
...
def deal_dwd(response):
    ...
    insert_count = result_dataframe.to_sql(HRStaffTransferFromLocationTableNameDwd, tarEngine, if_exists='append', index=False)
