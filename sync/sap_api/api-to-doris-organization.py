...
resultOrganizationColumn = ['Reference_ID', 'OrganizationName', 'Organization_Code', 'Subtype', 'Type',
                            'TopLevel_Organization', 'Superior_Organization', 'TopLevel_Organization_ID',
...
tarOrganizationTableNameDwd = "HROrganization_dwd"
tarOrganizationTableNameOds = "HROrganization_ods"
tarOrganizationTableNameOdsDetail = "HROrganization_ods_detail"
