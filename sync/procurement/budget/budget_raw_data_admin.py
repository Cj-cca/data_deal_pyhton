...
selectColumn = ["BudgetYear", "CurrentBudgetYear", "Territory", "Currency", "BudgetCategory", "Code",
                "Item", "DetailOrOffice", "NewFYVATRate", "NewFYBudget", "Description", "CurrentFYVATRate",
                "CurrentFYBudget", "CurrentFYActualCost", "CurrentFYYearToDateActualCost", "IsDeleted",
                "Id", "LastModificationTime", "IsComplete", "IsDisable"]

fieldMapping = {"BudgetYear": "budget_year", "CurrentBudgetYear": "current_budget_year", "Territory": "territory",
                "Currency": "currency", "BudgetCategory": "budget_category", "Code": "code", "Item": "item",
                "DetailOrOffice": "detail_or_office", "NewFYVATRate": "new_fy_vat_rate", "NewFYBudget": "new_fy_budget",
                "Description": "description", "CurrentFYVATRate": "current_fy_vat_rate",
                "CurrentFYBudget": "current_fy_budget", "CurrentFYActualCost": "current_fy_actual_cost",
                "CurrentFYYearToDateActualCost": "current_fy_year_to_date_actual_cost", "IsDeleted": "is_deleted",
                "Id": "id", "LastModificationTime": "last_modification_time", "IsComplete": "is_complete",
                "IsDisable": "is_disable"}
settingsCode = "Admin"
tarTableNameOds = "ods_fin_budget_raw_data_admin_hour_ei"
