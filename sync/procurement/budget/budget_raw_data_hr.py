...
selectColumn = ["BudgetYear", "FunctionName", "Team", "Territory", "Currency", "Item", "SubItem", "BAUOrPeoplePriority",
                "IsDeleted", "Id", "LastModificationTime", "iPowerOrSunCode", "NewFYBudgetLock2"]

fieldMapping = {"BudgetYear": "budget_year", "FunctionName": "function_name", "Team": "team", "Territory": "territory",
                "Currency": "currency", "Item": "item", "SubItem": "sub_item",
                "BAUOrPeoplePriority": "bauor_people_priority", "IsDeleted": "is_deleted", "Id": "id",
                "LastModificationTime": "last_modification_time", "iPowerOrSunCode": "ipower_or_sun_code",
                "NewFYBudgetLock2": "new_fy_budget_lock2"}
settingsCode = "HR"
tarTableNameOds = "ods_fin_budget_raw_data_hr_hour_ei"
