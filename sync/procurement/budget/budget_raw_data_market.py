...
selectColumn = ["BudgetYear", "Currency", "Territory", "ExpenseType", "EventName", "TeamOrIndustry", "Month", "ToWhom",
                "Purpose", "ValueToPwC", "NoOfAttendees", "Location", "Transportation", "Hotel", "FAndB", "Venue",
                "OrganisorOrSpeaker", "Others", "TotalBudget", "IsDeleted", "Id", "LastModificationTime"]

fieldMapping = {"BudgetYear": "budget_year", "Currency": "currency", "Territory": "territory",
                "ExpenseType": "expense_type", "EventName": "event_name", "TeamOrIndustry": "team_or_industry",
                "Month": "month", "ToWhom": "to_whom", "Purpose": "purpose", "ValueToPwC": "value_to_pwc",
                "NoOfAttendees": "no_of_attendees", "Location": "location", "Transportation": "transportation",
                "Hotel": "hotel", "FAndB": "fandb", "Venue": "venue", "OrganisorOrSpeaker": "organisor_or_speaker",
                "Others": "others", "TotalBudget": "total_budget", "IsDeleted": "is_deleted", "Id": "id",
                "LastModificationTime": "last_modification_time"}
settingsCode = "Market"
tarTableNameOds = "ods_fin_budget_raw_data_market_hour_ei"
