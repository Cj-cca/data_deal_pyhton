...
selectColumn = ["BudgetYear", "Currency", "FunctionName", "Programme", "Territory", "SubProgramme", "Code",
                "CourseName", "DeliveryMode", "CourseCategory", "CourseCategoryDetails", "CourseManager", "NewFYBudget",
                "NewFYTargetByLoSAssurance", "NewFYTargetByLoSRA", "NewFYTargetByLoSTax", "NewFYTargetByLoSDeals",
                "NewFYTargetByLoSConsulting", "NewFYTargetByLoSOFSDRD", "NewFYTargetByLoSOFSExclDRD",
                "NewFYTargetByLoSFCS", "IsDeleted", "Id", "LastModificationTime"]

fieldMapping = {"BudgetYear": "budget_year", "Currency": "currency", "FunctionName": "function_name",
                "Programme": "programme", "Territory": "territory", "SubProgramme": "sub_programme", "Code": "code",
                "CourseName": "course_name", "DeliveryMode": "delivery_mode", "CourseCategory": "course_category",
                "CourseCategoryDetails": "course_category_details", "CourseManager": "course_manager",
                "NewFYBudget": "new_fy_budget", "NewFYTargetByLoSAssurance": "new_fy_target_by_los_assurance",
                "NewFYTargetByLoSRA": "new_fy_target_by_los_ra", "NewFYTargetByLoSTax": "new_fy_target_by_los_tax",
                "NewFYTargetByLoSDeals": "new_fy_target_by_los_deals",
                "NewFYTargetByLoSConsulting": "new_fy_target_by_los_consulting",
                "NewFYTargetByLoSOFSDRD": "new_fy_target_by_los_ofs_drd",
                "NewFYTargetByLoSOFSExclDRD": "new_fy_target_by_los_ofs_excl_drd",
                "NewFYTargetByLoSFCS": "new_fy_target_by_los_fcs", "IsDeleted": "is_deleted", "Id": "id",
                "LastModificationTime": "last_modification_time"}
settingsCode = "LD"
tarTableNameOds = "ods_fin_budget_raw_data_ld_hour_ei"
