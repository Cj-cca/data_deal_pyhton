...
selectColumn = ["ProcurementRequestNo", "ProcurementURL", "CreateDateTime", "UpdateDateTime", "ProcurementDtlGuid",
                "ItemQuantity", "ItemUnit", "ItemPrice", "ItemCurrency", "ItemExchangeRate", "ItemVendorDiscount",
                "ItemTotalAmount", "ItemTotalAmountLC", "ItemTotalNetAmount", "ItemTotalNetAmountLC", "OUCode",
...
# params = {"UpdateDateFrom": '2023-08-01', "UpdateDateTo": '2023-11-01'}
...
def run():
    global totalInsertCount
    data_url = "https://vprocurement.asia.pwcinternal.com/vProcurementDataCenter/api/Procurement/ProcurementDetailList"
