...
if __name__ == '__main__':
    ...
    #获取没有删除到的booking数据
    select_sql = """select distinct booking_id from talenlink.ods_tbl_talent_link_original_day_st where (end_dt = '2024-5-19' or end_dt = '2024-5-18')
and booking_id not in (select booking_id from talenlink.ods_tbl_talent_link_original_day_st where end_dt = '9999-12-31')"""
