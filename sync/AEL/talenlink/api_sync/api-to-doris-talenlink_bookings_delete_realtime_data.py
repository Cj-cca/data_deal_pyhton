...
notNullField = []
resultField = ['deleted_entity_id']
fieldMapping = {'deleted_entity_id': 'bkg_id'}
...
tarTableNameDwd = "ods_tbl_talent_link_bookings_deleted_realtime_day_ei"
tarTableNameOds = "ods_tbl_talent_link_bookings_deleted_realtime_day_ei"
...
def deal_dwd(response):
    data_frame = pandas.json_normalize(response['result'], record_path=["deleted_entities"])
...
if __name__ == '__main__':
    apiType = "bookings"
    startTimeStr = '2024-06-17'
    endTimeStr = '2024-06-24'
    date_gap = 1
    # truncate_table(tarTableNameOds)
    # 增量同步数据
    APIDeltaUrl = "https://cncapppwv5008.asia.pwcinternal.com/talentlinkapi/v2/{apiType}/delta/deleted-ids/{apiRequestStartTime}/{apiRequestEndTime}"
